...
class RegistrationForm(FlaskForm):
    ...
    full_name = StringField(
        label="Full Name", validators=[DataRequired(), Length(min=3, max=50)]
    )
    email = StringField(
        label="Email",
    ...
    confirm_password = PasswordField(
        label="Confirm Password", validators=[DataRequired(), EqualTo("password_hash")]
    )
    phone_number = StringField(
        label="Phone Number", validators=[DataRequired(), Length(min=10, max=15)]
    )
    address = StringField(label="Address", validators=[DataRequired()])
    pin_code = StringField(
        label="Pin Code", validators=[DataRequired(), Length(min=6, max=10)]
    )
...
class LoginForm(FlaskForm):
    ...
    email = StringField(
        label="Registered Email Id", validators=[DataRequired(), Email()]
    )
...
class ParkingLotForm(FlaskForm):
    ...
    maximum_number_of_spots = IntegerField(
        label="Maximum Number of Spots", validators=[DataRequired(), NumberRange(min=1)]
    )
...
class ReservedSpotForm(FlaskForm):
    ...
    spot_id = StringField(
        label="Spot Id", validators=[DataRequired()], render_kw={"readonly": True}
    )
    user_id = StringField(
        label="User Id", validators=[DataRequired()], render_kw={"readonly": True}
    )
    lot_id = StringField(
        label="Lot Id", validators=[DataRequired()], render_kw={"readonly": True}
    )
...
class ReleasedForm(FlaskForm):
    ...
    duration = StringField(
        label="Total Duration In Hour(s)", render_kw={"readonly": True}
    )
